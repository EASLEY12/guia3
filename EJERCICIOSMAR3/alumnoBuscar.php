...
<html>
	...
	<div class="jumbotron">
		<form action="modificarAlumno.php" method="post" id="alumno">
			...
			<div class="col-xs-2">
				...
				<input type="text" name="carnet" value='<?php print $datos[0][5] ?>' class="required digits form-control">
			</div>
		</div>
	<div class="row">
		<div class="col-xs-2">
		...
		<div class="col-xs-2">
			<input type="text" name="nombre" value='<?php print $datos[0][1]?>' class="required form-control">
		</div>
	</div>
	<div class="row">
		<div class="col-xs-2">
		...
		<div class="col-xs-2">
			<input type="text" name="apellido" value='<?php print $datos[0][2]?>' class="required form-control">
		</div>
	</div>
	<div class="row">
		<div class="col-xs-2">
		...
		<div class="input-group">
			<input type="text" name="Fecha_nac" id="fechac" value='<?php print $datos[0][3]?>' class="required form-control">
	...
	<div class="row">
		...
		<div class="col-xs-2">
			<input type="text" name="dir" value='<?php print $datos[0][4]?>' class="required form-control">
		</div>
	</div>
	<div class="row">
		<div class="col-xs-2">
